import sectionsIndexData from "../../content/courses/sections.json";
...
const sectionManifestModules = import.meta.glob(
  "../../content/courses/sections/*/section.json",
  {
    eager: true,
    import: "default",
  }
...
const lessonManifestModules = import.meta.glob(
  "../../content/courses/sections/*/lessons/*/lesson.json",
  {
    eager: true,
    import: "default",
  }
