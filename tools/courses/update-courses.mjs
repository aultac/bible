...
notes.md backups, summary .docx files are converted to summary.md and their Title:
fields become video descriptions, lesson-root KMZ files are converted into GeoJSON
map assets, the configured YouTube playlist snapshot is refreshed, and a
gzip-compressed browser search index is generated.
